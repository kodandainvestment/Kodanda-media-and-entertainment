...
//   { icon: <FiMail />, label: "Email", value: "hr@kodandamedia.com" },
//   { icon: <FiPhone />, label: "Call", value: "+91 98765 43210" },
// ];

// export default function Contact() {
//   return (
//     <section id="contact" className="relative min-h-screen bg-white px-6 py-20 overflow-hidden">
...
//           direction="diagonal"
//           speed={0.4}
//           borderColor="rgba(201, 17, 17)"
//           squareSize={60}
//           hoverFillColor="#C91111"
//           hoverTrailAmount={4}
//           shape="square"
//         />
//         {/* soften dark vignette from ShapeGrid with white overlay */}
...
//           <p className="text-[#C91111] text-sm tracking-widest uppercase mb-2">Get In Touch</p>
//           <h2 className="text-4xl sm:text-5xl font-extrabold text-gray-900">
//             Let's <span className="text-[#C91111]">Talk</span>
//           </h2>
...
//                 <div
//                   key={item.label}
//                   className="flex flex-col items-center gap-2 bg-white/80 border border-gray-200 rounded-2xl px-2 py-4 text-center backdrop-blur-sm"
//                 >
//                   <div className="w-9 h-12 rounded-xl bg-[#C91111]/10 flex items-center justify-center text-[#C91111] text-base flex-shrink-0">
//                     {item.icon}
//                   </div>
//                   <div>
//                     <p className="text-gray-400 text-[10px]">{item.label}</p>
//                     <p className="text-gray-800 font-semibold text-[11px] leading-snug break-words">{item.value}</p>
//                   </div>
//                 </div>
//               ))}
//             </div>
...
//           {/* Right — Form with leaning man */}
//           <div className="flex-1 relative">
//             <img
//               src={menImg}
//               alt=""
//               className="hidden lg:block absolute -right-36 bottom-0 h-[200px] w-auto object-contain z-10 pointer-events-none select-none drop-shadow-xl"
//             />

//             <div className="relative z-0 w-full bg-white/80 backdrop-blur-sm border border-gray-200 rounded-2xl p-8 flex flex-col gap-4 shadow-sm">
//               <input
//                 type="text"
//                 placeholder="Your Name"
//                 className="w-full border border-gray-200 bg-white rounded-lg px-4 py-3 text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-[#C91111]"
//               />
//               <input
//                 type="email"
...
//                 className="w-full border border-gray-200 bg-white rounded-lg px-4 py-3 text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-[#C91111] resize-y"
//               />
//               <button className="w-full bg-[#C91111] text-white py-4 rounded-xl font-semibold flex items-center justify-center gap-2 hover:bg-[#a50e0e] transition">
//                 Send Message <FiSend />
//               </button>
//             </div>
//           </div>
...
/* ─── Data ───────────────────────────────────────────────────────────────── */
const info = [
  { icon: FiMapPin, label: "Visit Us", value: "A.B Road, Indore, MP" },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-7 items-start">
            ...
            <div className="flex flex-col gap-4">
              <Reveal direction="left" delay={0.1}>
                <Tilt strength={8}>
                  <div className="rounded-3xl overflow-hidden border border-[#C91111]/[0.12] shadow-[0_8px_40px_rgba(0,0,0,0.07)] relative">
