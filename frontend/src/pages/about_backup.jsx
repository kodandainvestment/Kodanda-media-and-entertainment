...
const values = [
  {
    ...
    desc: "We create high-retention Shorts and Reels designed to capture attention within seconds and maximize reach.",
  },
  {
    icon: <FiEye />,
...
export default function About() {
  return (
    ...
    >
      ...
      <div className="max-w-5xl mx-auto flex flex-col gap-20">
        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center">
          <div className="flex-1">
            ...
            <h2 className="text-4xl sm:text-5xl font-extrabold text-gray-900 leading-tight mb-5">
              ...
              <span className="text-[#C91111]">Matter</span>
            </h2>
            <p className="text-gray-800 text-base leading-relaxed mb-4">
              ...
              across YouTube, Instagram, and emerging digital spaces — each
              designed with a clear identity, strong storytelling, and a
              system-driven production approach.
            </p>
            <p className="text-gray-800 text-base leading-relaxed">
              From finance and geopolitics to motivation, spirituality, and
              entertainment — we don’t just publish content, we build{" "}
              <span className="font-bold">
                high-impact knowledge communities at scale.
              </span>{" "}
            </p>
          </div>
            ...
            {stats.map((s, i) => {
              ...
              return (
                <AnimatedCard
                  key={s.label}
                  delay={i * 0.1}
                  className="stat-card bg-white border border-gray-200 rounded-2xl p-6 flex flex-col items-center gap-2 text-center shadow-sm"
                >
                  <span className="stat-icon text-[#C91111] text-2xl">
                    {s.icon}
                  </span>
          ...
          <div>
            <div className="mb-8">
              ...
              <p className="text-gray-800 text-base mt-3 leading-relaxed">
                We are a team of strategists, storytellers, researchers, and
                creators working together to redefine digital content in India.
                Our approach is not random — it is structured, data-driven, and
            ...
            <div className="grid grid-cols-1 sm:grid-cols-1 gap-4">
              {timeline.map((t, i) => (
                <AnimatedCard
                  key={t.title}
                  delay={i * 0.1}
                  className="timeline-card bg-white border border-gray-200 rounded-2xl p-6 flex gap-4 shadow-sm"
                >
                  <div className="year-badge flex-shrink-0 w-14 h-14 rounded-xl bg-[#C91111]/10 flex items-center justify-center text-[#C91111] font-extrabold text-sm">
                    {t.year}
                  </div>
                  <div>
          ...
          <div>
            <div className="mb-8">
              ...
              <p className="text-gray-800 leading-relaxed mt-3">
                We create niche content channels focused on delivering real
                value. Our approach blends strategy, creativity, and
                consistency. We help brands grow through engaging and meaningful
                content. From idea to scale, we build channels that truly
        ...
        <div>
          <div className="text-center mb-10">
            ...
            <h3 className="text-3xl sm:text-4xl font-extrabold text-gray-900">
              Mission & <span className="text-[#C91111]">Vision</span>
            </h3>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            {/* <p className="text-gray-800 leading-relexed text-base">
              “Where content meets strategy, and storytelling creates impact.”
            </p> */}
          </div>
        </div>
      ...
      {/* <div>
          <div className="text-center mb-10">
            <p className="text-[#C91111] text-xs tracking-widest uppercase mb-3 font-semibold">Our People</p>
            <h3 className="text-3xl sm:text-4xl font-extrabold text-gray-900">
              Meet The <span className="text-[#C91111]">Minds</span>
            </h3>
          </div>
          <div style={{ height: "400px", position: "relative" }}>
            <CircularGallery
              items={team.map((m) => ({ image: m.img, text: `${m.name} — ${m.role}` }))}
              bend={-1}
              textColor="#e21616"
              borderRadius={0.5}
              scrollSpeed={3.4}
