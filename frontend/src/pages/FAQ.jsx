...
export default function FAQ() {
  ...
  const visibleFaqs = isMobile ? faqs.slice(0, 5) : faqs;
    ...
    <>
      ...
      <section
        ...
        style={{
          ...
          padding: isMobile
            ? "60px 16px 30px"
            : "clamp(60px, 10vw, 100px) clamp(16px, 4vw, 24px) 60px",
          overflow: "hidden",
          fontFamily: "'DM Sans', sans-serif",
        }}
      >
        ...
        {/* ══ Content ══════════════════════════════════════════════════════ */}
        <div style={{ position: "relative", zIndex: 2, maxWidth: 1100, margin: "0 auto", display: "flex", flexDirection: "column", gap: isMobile ? 20 : 32 }}>
