...
export default function PrivacyPolicy() {
  ...
  return (
    <>
      <Helmet>
        <title>Privacy Policy | Kodanda Media</title>
        <link rel="canonical" href="https://kodandamedia.com/privacy-policy" />
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-sm text-gray-600 leading-relaxed space-y-6">
            ...
            <div>
              ...
              <p>
                Kodanda Media and Entertainment Pvt. Ltd. respects your privacy
            ...
            <div>
              ...
              <ul className="list-disc pl-5 space-y-1">
                ...
                <li>
                  ...
                  Browser type, IP address, device info, website usage data
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <p>
                Our content is not directed at children under 13. We do not
