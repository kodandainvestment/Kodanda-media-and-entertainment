        ...
        <div className="max-w-7xl mx-auto px-6 pt-14 pb-10">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-10 border-b border-gray-700/60 pb-10">
            ...
            <div className="lg:col-span-2">
              <p className="text-2xl font-bold text-white mb-3">
                Kodanda{" "}
                <span className="bg-gradient-to-r from-[#E63B57] to-[#f07060] bg-clip-text text-transparent">
                  Media
                </span>
              </p>
              ...
              <ul className="space-y-2 text-sm">
                <li className="flex items-center gap-2">
                  <FiMail className="text-[#f07060] shrink-0" />
                  <span>CEO@kodandamedia.com</span>
                </li>
                <li className="flex items-center gap-2">
                  <FiPhone className="text-[#f07060] shrink-0" />
                  <span>+91-9876543345</span>
                </li>
                <li className="flex items-center gap-2">
                  <FiMapPin className="text-[#f07060] shrink-0" />
                ...
                {services.map((s) => (
                  <li key={s}>
                    <button
                      ...
                      className="hover:text-[#f07060] transition-colors text-left"
                    >
                      {s}
                    </button>
                  </li>
              ...
              <div className="flex flex-wrap gap-2">
                {socials.map((s) => (
                  <a
                    ...
                    href={s.href}
                    aria-label={s.label}
                    className="w-9 h-9 rounded-full border border-gray-600 flex items-center justify-center text-gray-400 hover:text-[#f07060] hover:border-[#f07060] transition"
                  >
                    {s.icon}
                  </a>
                ))}
          ...
          <div className="pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-gray-500">
            ...
            <div className="flex gap-4">
              <button onClick={() => setShowPrivacy(true)} className="hover:text-[#f07060] transition-colors">
                Privacy Policy
              </button>
              <button onClick={() => setShowTerms(true)} className="hover:text-[#f07060] transition-colors">
                Terms of Service
              </button>
            </div>
          </div>
